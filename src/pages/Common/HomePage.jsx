              ...
              {features.map((feature, index) => (
                ...
                >
                  <div className="flex items-start gap-5">
                    <div
                      className={`w-14 h-14 rounded-2xl ${feature.bg} flex items-center justify-center ${feature.color} shrink-0 transition-transform group-hover:scale-110 duration-500`}
                    >
                      <feature.icon size={28} strokeWidth={1.5} />
                    </div>
                    <div className="pt-1">
                      <h3 className="text-xl font-bold text-slate-900 mb-2 group-hover:text-indigo-600 transition-colors hover:">
                        {/* Heading wrapped in Link as requested */}
                        <Link to={feature.link} className="focus:outline-none">
